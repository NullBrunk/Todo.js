        ...
        <nav className="bg-gray-800 py-2">
            <div className="flex h-16">
                <div className="flex flex-1 items-center justify-center">
                    ...
                    <div className="hidden ml-6 sm:block flex space-x-4">
                        ...
                        <a href="https://nullbrunktodo.netlify.app/" className="navbar-links navbar-links-hover">Example</a>
            ...
            <div className="sm:hidden">
                <div className="space-y-1 p-2">
                    ...
                    <a href="https://nullbrunktodo.netlify.app/" className="navbar-links-mobile navbar-links-hover">Example</a>
